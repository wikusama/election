        ...
        <form method="POST" enctype='multipart/form-data'>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control required" id="lead_name" name="lead_name">
                </div>
                <div class="form-group">
                    <label for="lead_about">About</label>
                    <textarea class="form-control required" id="lead_about" name="lead_about"></textarea>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control required" id="deputy_name" name="deputy_name">
                </div>
                <div class="form-group">
                    <label for="deputy_about">About</label>
                    <textarea class="form-control required" id="deputy_about" name="deputy_about"></textarea>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-12">
                <h3>Their Vision</h3>
                <div class="form-group">
                    <textarea class="form-control required" id="vision" name="vision"></textarea>
                </div>
            </div>
            <div class="col-md-12">
                <h3>Their Mission</h3>
                <div class="form-group">
                    <textarea class="form-control required" id="mission" name="mission"></textarea>
                </div>
            </div>
            <div class="col-md-12">
                <br clear="all">
